...
<input class="button button_add" value="" type="submit"></a><?php */?></td>
</tr>
</table>
</div>
<div class="content">
          ...
          <thead>
            <tr height="25">
              ...
              <td width="158" align="left" valign="middle" class="sort">
					<div >
					<a href="index.php?option=com_memberlist&ord=ASC&fld=us_name" class="up" title="up"></a>
					<a href="index.php?option=com_memberlist&ord=DESC&fld=us_name" class="down" title="down"></a>
			  </div></td>
			 ...
			 <td width="65" align="left" valign="middle" >Type</td>
			  <td width="165" align="left" valign="middle" class="sort">
					<div >
					<a href="index.php?option=com_memberlist&ord=ASC&fld=roletype" class="up" title="up"></a>
			  <a href="index.php?option=com_memberlist&ord=DESC&fld=roletype" class="down" title="down"></a></div></td>
			  <td width="35" align="center" valign="middle" >status</td>
<!--   <td width="32" align="center" valign="middle" >Edit</td>--><td width="76" align="center" valign="middle" >Delete</td>
            </tr>
          </thead>
			<tbody>
			<?php
			...
			<?php /*?><?php if($all_users->user_id!="1"){
			?>
			<input type="checkbox" name="list[]" id="list" value="<?php echo $all_users->user_id; ?>" />
			<?php }else{
			?>
			...
			<?php 
			if($all_users->roletype=="level1")
			echo "Level 1 Administrator";
			else if($all_users->roletype=="level2")
			echo "Front End User";
			else
			echo "Senior Level Administrator";
			?></td>
			...
			<?php /*?><td align="center" valign="middle"x><a title="edit" href="index.php?option=com_memberlist_insert&id=<?php echo $all_users->user_id;?>"><img src="allfiles/icon_edit.png" alt="Edit" border="0"></a></td><?php */?>
			<td align="center" valign="middle">
						<a title="delete" href="#" onClick="var q = confirm('Are you sure you want to delete selected record?'); if (q) { window.location = 'index.php?option=com_memberlist&action=delete&id=<?php echo $all_users->user_id;?>'; return false;}"><img src="allfiles/icon_delete.png"  alt="Delete" border="0"/></td>
			</tr>
			<?php
					$ii++;
							}
   ...
   <div class="box">
    ...
    <div class="content">
	<form action="index.php?option=com_memberlist_insert" method="post" id="frmCreateAdmin" name="frmCreateAdmin" class="middle_form" onSubmit="return validate();">
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
	<td width="26%" align="left" valign="middle"><label class="title">User Name: </label></td>
	<td width="74%" align="left" valign="middle"><input name="name" id="name" class="text_large required" type="text" value="<?php echo $indivdata->us_name?>">&nbsp;&nbsp;<span id="uname_error" style="display:none;">Please Enter Username</span></td>
	</tr>
	<tr>
	<td colspan="2" height="5" align="left" valign="middle" ></td>
	</tr>
	<tr>
	<td align="left" valign="middle"><label class="title">Password : </label></td>
	...
	<tr>
	<td align="left" valign="middle"><label class="title">Email : </label></td>
	...
	?>
	<tr>
	<td align="left" valign="middle"><label class="title">Role Type : </label></td>
	<td align="left" valign="middle">
	<select name="roletype" id="roletype" class="select_large required">
	<option value="senior">Senior Level Administrators</option>
	<option value="level1">Level 1 Administrator</option>
	<!--<option value="level2">Level 2 Administrator</option>-->
	</select>
	<script type="text/javascript">
	...
	<tr>
	<td align="left" valign="middle"><label class="title">Status : </label></td>
	<td align="left" valign="middle">
