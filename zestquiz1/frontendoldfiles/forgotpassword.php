...
if($_POST['action']=="forgothere" && $_POST['txt_username']!=""){
$frontuserObj->userForgotpassword($_POST['txt_username']);
}
?>
<style type="text/css">
<!--
...
<td height="28" align="left" valign="middle"><input type="hidden" name="action" value="forgothere"><input type="image" src="images/submit_51.png" value="Register"></td>
</tr>
<tr>
<td height="28" align="left" valign="middle"></td>
<td height="28" align="left" valign="middle"><a href="registeration.php" class="morelink">New User ?</a>&nbsp;&nbsp;<a href="login.php" class="morelink">Login Here ?</a></td>
</tr>
