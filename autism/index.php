...
if(isset($_GET['del']))
{
  //echo "test";exit; 
  $prov_id=$_GET['del'];
  $proAlldata=$commonObj->deleteProviderlist($prov_id);
}
if(isset($_POST['go']))
{
...
Find a provider</a></li> -->
    ...
    <div class="container">
        ...
        <?php if($_GET['rewmsg']!=""){?>
                ...
                <div class="isa_success">
                    <i class="fa fa-check"></i>
                    Providers deletec successfully.
                </div>
                <?php }?>
                ...
                <table class="table table-bordered table-hover">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center" style="width:14%">Compare 
                    ...
                    <tbody>
                        ...
                        .starRating<?php echo $k;?>:not(old){
                            ...
                            .starRating<?php echo $k;?>:not(.nohover):hover {  
                        ...
                        <tr class="cur-poi" >
                            ...
                            <td><?php $k;?>
                                    <span class="starRating<?php echo $k;?>" style="cursor:default;">
                                        <input id="rating5<?php echo $k;?>" type="radio" id="rating5<?php echo $k;?>" disabled="disabled" name="rating<?php echo $k;?>" value="5" <?php if($all_prod->rating==5){?>checked<?php }?> style="cursor:default;">
                                        <label for="rating5<?php echo $k;?>" id="rating5<?php echo $k;?>" style="cursor:default;">5</label>
                                        <input id="rating4<?php echo $k;?>" type="radio" id="rating4<?php echo $k;?>" disabled="disabled" name="rating<?php echo $k;?>" value="4" <?php if($all_prod->rating==4){?>checked<?php }?>  style="cursor:default;">
                                        <label for="rating4<?php echo $k;?>" id="rating4<?php echo $k;?>" style="cursor:default;">4</label>
                                        <input id="rating3<?php echo $k;?>" type="radio" id="rating3<?php echo $k;?>" disabled="disabled" name="rating<?php echo $k;?>" value="3" <?php if($all_prod->rating==3){?>checked<?php }?>  style="cursor:default;">
                                        <label for="rating3<?php echo $k;?>" id="rating3<?php echo $k;?>" style="cursor:default;">3</label>
                                        <input id="rating2<?php echo $k;?>" type="radio" id="rating2<?php echo $k;?>" disabled="disabled" name="rating<?php echo $k;?>" value="2" <?php if($all_prod->rating==2){?>checked<?php }?>  style="cursor:default;">
                                        <label for="rating2<?php echo $k;?>" id="rating2<?php echo $k;?>" style="cursor:default;">2</label>
                                        <input id="rating1<?php echo $k;?>" type="radio" id="rating1<?php echo $k;?>" disabled="disabled" name="rating<?php echo $k;?>" value="1" <?php if($all_prod->rating==1){?>checked<?php }?>  style="cursor:default;">
                                        <label for="rating1<?php echo $k;?>" id="rating1<?php echo $k;?>" style="cursor:default;">1</label>
                                      </span>
                            ...
                            <td class="text-center">
                              <!--<a data-toggle="modal" data-id="<?php echo $all_prod->id;?>" title="Add this item" class="open-EditBookDialog_<?php echo $all_prod->id;?>" href="#EditBookDialog<?php echo $all_prod->id;?>">Edit</a>-->
                              <a href="javascript:void(0);" class="glyphicon glyphicon-trash" onclick="return Deleteqry(<?php echo $all_prod->id;?>);"></a></td>
                        </tr>
                        <?php $k++;} } else { ?>
                        <tr class="cur-poi" >
...
<script>
    ...
    $(document).on("click", ".open-EditBookDialog", function () {
     var myProviderEditId = $(this).data('id');
     $(".modal-body #myProviderEditId").text( myProviderEditId );
...
<?php }?>
<!--End of the View Popup provider-->

<!--View Edit Popup provider-->
 <?php 
   foreach($proAlldata as $all_prod) {  ?>
    <div id="EditBookDialog<?php echo $all_prod->id; ?>" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <!-- Modal content-->
            <div class="modal-content b-r-0">
                <div class="modal-header modal-header-bg-blue">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Edit Provider Details</h4>

                </div>
                <div class="modal-body">
                    <!-- <span id="bookId" ></span> -->
                   <?php echo $value = "<span id='myProviderEditId' ></span>";
                  ...
                  <div class="row">
                        <div class="col-md-4"><strong>Provider Name:</strong></div>
                        <div class="col-md-8"><input type="text" class="form-control" id="name" name="username" value="<?php echo $result_fet['name'];?>" required></div>
                    </div>
                    <div class="row">
                        <div class="col-md-4"><strong>Location:</strong></div>
                        <div class="col-md-8">
                          <?php $loc_val=explode(',', $result_fet['location']); //print_r($loc_val[$jk]);
                            $cont_loc = count($loc_val);?>
                            <?php for($jk==0;$jk>$cont_loc;$jk++){?>
                            <?php echo $loc_val[$jk]?>
                            <?php }?>
                          <select class="select2" id="location[]" name="location[]" multiple="multiple" style="width:250px;" required>
                            ...
                            <option value="Los Angeles" <?php $loc_val[1]; ?>>Los Angeles</option>
                            ...
                            <?php //echo $result_fet['location']; ?>

                            <script type="text/javascript">
                            /*for(var i=0;i<document.getElementById('location[]').length;i++)
                            {
                                if(document.getElementById('location[]').options[i].value=="<?php echo $loc_val[1]; ?>")
                                {
                                document.getElementById('location[]').options[i].selected=true
                                }
                            }   */  
                          </script>
                          <?php  //$result_fet['location'];?></div>
                    </div>
                    <div class="row">
                        <div class="col-md-4"><strong>Service:</strong></div>
                        <div class="col-md-8">
                          <select class="form-control" id="sL" name="slocation" required>
                            ...
                            {
                                if(document.getElementById('sL').options[i].value=="<?php echo $result_fet['service_locations']; ?>")
                                {
                                document.getElementById('sL').options[i].selected=true
                                }
                            }     
                            </script>
                          <?php // $result_fet['service_locations'];?></div>
                    </div>
                    <div class="row">
                        <div class="col-md-4"><strong>Age Served:</strong></div>
                        <div class="col-md-8">
                          ...
                          <script type="text/javascript">
                            for(var i=0;i<document.getElementById('aS').length;i++)
                            {
                                if(document.getElementById('aS').options[i].value=="<?php echo $result_fet['ages_served']; ?>")
                                {
                                document.getElementById('aS').options[i].selected=true
                                }
                            }     
                            </script>
                          <?php //echo $result_fet['ages_served'];?></div>
                    </div>
                    <div class="row">
                        <div class="col-md-4"><strong>Insurance:</strong></div>
                        <div class="col-md-8">
                          ...
                          <script type="text/javascript">
                            for(var i=0;i<document.getElementById('insurance[]').length;i++)
                            {
                                if(document.getElementById('insurance[]').options[i].value=="<?php echo $result_fet['insurance_accepted']; ?>")
                                {
                                document.getElementById('insurance[]').options[i].selected=true
                                }
                            }     
                          </script>
                          <?php //echo $result_fet['insurance_accepted'];?></div>
                    </div>
                    <div class="row">
                        <div class="col-md-4"><strong>Description:</strong></div>
                        <div class="col-md-8"><textarea type="text" class="form-control" id="sD" rows="5" name="address" required><?php echo $result_fet['description'];?></textarea></div>
                    </div>
                    <div class="row">
                        <div class="col-md-4"><strong>Regional funding:</strong></div>
                        <div class="col-md-8">
                          ...
                          <script type="text/javascript">
                            for(var i=0;i<document.getElementById('rC').length;i++)
                            {
                                if(document.getElementById('rC').options[i].value=="<?php echo $result_fet['regional_fund']; ?>")
                                {
                                document.getElementById('rC').options[i].selected=true
                                }
                            }     
                          </script>
                          <?php //echo $result_fet['regional_fund'];?></div>
                    </div>
                    <div class="row">
                        <div class="col-md-4"><strong>Provider Category:</strong></div>
                        <div class="col-md-8">
                          ...
                          <script type="text/javascript">
                            for(var i=0;i<document.getElementById('pC').length;i++)
                            {
                                if(document.getElementById('pC').options[i].value=="<?php echo $result_fet['provider_cat']; ?>")
                                {
                                document.getElementById('pC').options[i].selected=true
                                }
                            }     
                          </script>
                          <?php //echo $result_fet['provider_cat'];?></div>
                    </div>
                    <div class="row">
                        <div class="col-md-4"><strong>Languages:</strong></div>
                        <div class="col-md-8">
                          ...
                          <script type="text/javascript">
                            for(var i=0;i<document.getElementById('ls').length;i++)
                            {
                                if(document.getElementById('ls').options[i].value=="<?php echo $result_fet['languages']; ?>")
                                {
                                document.getElementById('ls').options[i].selected=true
                                }
                            }     
                          </script>
                          <?php //echo $result_fet['languages'];?></div>
                    </div>
                    <div class="row">
                        <div class="col-md-4"><strong>Speciality:</strong></div>
                        <div class="col-md-8">
                          <input type="text" class="form-control" id="sp" name="speciality" value="<?php echo $result_fet['speciality'];?>" required>
                          <?php //echo $result_fet['speciality'];?></div>
                    </div>
                    <div class="row">
                        <div class="col-md-4"><strong>Website:</strong></div>
                        <div class="col-md-8">
                          <input type="text" class="form-control" id="website" name="website" value="<?php echo $result_fet['website'];?>" required>
                          <?php //echo $result_fet['website'];?></div>
                    </div>
                    <div class="row">
                        <div class="col-md-4"><strong>Phone:</strong></div>
                        <div class="col-md-8">
                          <input type="text" class="form-control" id="phone" name="phone" value="<?php echo $result_fet['Phone'];?>" required>
                          <?php //echo $result_fet['Phone'];?></div>
                    </div>
                    ...
                    <form name="" action="" method="post">
                        ...
                        <div class="text-right">
                            ...
                            <span class="glyphicon glyphicon-remove"></span>Cancel</a>
                            <input type="hidden" name="pr_id" value="<?php echo $result_fet['id'];?>"><br>
                            <button class="btn btn-success btn-md" name="editsubmit" type="submit">Submit</button>
                        </div>
