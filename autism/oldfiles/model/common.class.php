...
$where="username='".$_POST['uname']."' and password='".$callConfig->passwordEncrypt($_POST['key'])."' and status='Active'";
 echo $query=$callConfig->selectQuery(TPREFIX.TBL_USERS,'*',$where,'','',''); 
	...
	$fieldnames=array('rating'=>$_POST['rating_popup'],'review_comment'=>$_POST['review_comment']);
	$fieldnames_review=array('rev_comment'=>$_POST['review_comment'],'rev_rating'=>$_POST['rating_popup'],'pr_id'=>$_POST['pr_id'],'us_id'=>$_POST['us_id'],'log'=>$date_now);
