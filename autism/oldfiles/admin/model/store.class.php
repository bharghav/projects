...
/*=========================================Product updating End	=============================================*/
	...
	function getAllOrdersList($sortfield,$order,$start,$limit)	
	{
		...
		$order=$whr.' '.$sortfield.' '.$order;		
	 	//$query="select DISTINCT txn_no,ordered_date,orderid,status,totalprice,id FROM tb_orders ".$whr." GROUP BY txn_no ORDER BY id DESC LIMIT ".$start.",".$limit.""; 
	...
	function getAllOrdersListdb($countd,$sortfield,$order,$start,$limit)	
	{
		...
		if($_GET['week']!='') 
		{ 
		$query="select DISTINCT txn_no,dateon,orderid,status,totalprice,cust_id,pro_name,quantygrams FROM tb_orders where dateon BETWEEN '".$minusweek."' AND '".$todaydate."'";
		} 
		else if($_GET['month']!='') 
		{
		$query="select DISTINCT txn_no,dateon,status,orderid,totalprice,cust_id,pro_name,quantygrams FROM tb_orders where dateon BETWEEN '".$month."' AND '".$todaydate."'";
		
		} 
		else if($_GET['process']=='In Progress') 
		{
		$query="select DISTINCT txn_no,dateon,status,orderid,totalprice,cust_id,pro_name,quantygrams FROM tb_orders where status='In Progress'";
		} 
		else if($_GET['process']=='Decline') 
		{
		$query="select DISTINCT txn_no,dateon,status,orderid,totalprice,cust_id,pro_name,quantygrams FROM tb_orders where status='Decline'";		
		} 
		else if($_GET['process']=='Newordered') 
		{
		$query="select DISTINCT txn_no,dateon,status,orderid,totalprice,cust_id,pro_name,quantygrams FROM tb_orders where status='Newordered'";
		//$query="select 'GROUP BY txn_no' FROM tb_orders where status='Newordered'";
		}
		//echo "ssyam";
		//$query="SELECT * FROM tb_orders ".$whr." ORDER BY id DESC LIMIT ".$start.",".$limit.""; 
		//echo $query;exit;
	...
	function getAllOrdersListdbCount($countd,$sortfield,$order,$start,$limit)	
	{
		...
		if($_GET['week']!='') {
		 ...
		 $query="select DISTINCT txn_no,dateon,cust_id,pro_name,quantygrams FROM tb_orders where dateon BETWEEN '".$minusweek."' AND '".$todaydate."'";
		 
		} else if($_GET['month']!='') {
		
		$query="select DISTINCT txn_no,dateon,cust_id,pro_name,quantygrams FROM tb_orders where dateon BETWEEN '".$month."' AND '".$todaydate."'";
		
		} else if($_GET['process']=='In Progress') {
		
		$query="select DISTINCT txn_no,cust_id,pro_name,quantygrams FROM tb_orders where status='In Progress'";
		
		} else if($_GET['process']=='Decline') {
		
		$query="select DISTINCT txn_no,cust_id,pro_name,quantygrams FROM tb_orders where status='Decline'";		
		
		} else if($_GET['process']=='Newordered') {
		
		$query="select DISTINCT txn_no,cust_id,pro_name,quantygrams FROM tb_orders where status='Newordered'";
	...
	function getAllOrdersListountshowdb($sortfield,$order,$start,$limit)	
	{
		...
		$order=$whr.' '.$sortfield.' '.$order;	
		$whr='GROUP BY txn_no';	
	$query="SELECT COUNT(DISTINCT txn_no) FROM tb_orders"; 
		return $callConfig->getCount($query);
	} 
	...
	function getorderprice($id)	
	{
		...
		$whr='txn_no="'.$id.'"';
		$order=$whr.' '.$sortfield.' '.$order;		
		 $query="SELECT * FROM tb_orders where txn_no='".$id."' ORDER BY id DESC LIMIT ".$start.",".$limit.""; 
		return $callConfig->getAllRows($query);
	} 
...

  {
	...
	if($sortfield!="" && $order!="") $order=$sortfield.' '.$order;
	 ...
	 $query=$callConfig->selectQuery(TPREFIX.TBL_ORDERS,'*','txn_no="'.$id.'"',$order,$start,$limit);
	...
	function getAllOrdersListstatus($status,$sortfield,$order,$start,$limit)	
	{
		...
		$query="select DISTINCT txn_no,dateon,orderid,status,totalprice,id FROM tb_orders where status='".$status."' ORDER BY id DESC LIMIT ".$start.",".$limit."";
		
		/*echo $query = "select * from tb_orders group by txn_no oredr by id DESC ";*/
		return $callConfig->getAllRows($query);
	} 
	...
	function getAllOrdersListstatuscount($status,$sortfield,$order,$start,$limit)	
	{
		...
		global $callConfig;		
		 ...
		 $query="select DISTINCT txn_no,orderedon,orderid,status,totalprice FROM tb_orders where status='".$status."' ORDER BY id DESC ";
	...
	function getAllOrderssearchList($post,$sortfield,$order,$start,$limit)	
	{
	    ...
	    $query="SELECT DISTINCT txn_no,dateon,orderid,status,totalprice FROM tb_orders where ".$whr." ORDER BY id DESC LIMIT ".$start.",".$limit.""; 
		//exit;
		return $callConfig->getAllRows($query);
	} 
	...
	function getAllOrderssearchListCount($status,$sortfield,$order,$start,$limit)	
	{
		...
		$whr='GROUP BY txn_no';
		$order=$whr.' '.$sortfield.' '.$order;		
		$query="SELECT DISTINCT txn_no,dateon,orderid,status,totalprice FROM tb_orders where status='".$status."' ORDER BY id DESC LIMIT ".$start.",".$limit."";
		return $callConfig->getCount($query);
	} 
  ...
  function getAllOrdersListCount($sortfield,$order,$start,$limit)
  {
	...
	$order=$whr.' '.$sortfield.' '.$order;		
	$query="select DISTINCT txn_no,dateon,orderid,status,totalprice FROM tb_orders ".$whr." ORDER BY id DESC LIMIT ".$start.",".$limit.""; 
...
// end store coupons //
...

  {
	...
	global $callConfig;
	 ...
	 $query=$callConfig->selectQuery(TPREFIX.TBL_ORDERS,'*','id="'.$id.'"','','','');
	return $callConfig->getAllRows($query);
	}
