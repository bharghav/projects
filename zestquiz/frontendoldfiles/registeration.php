...
$frontuserObj->userRegisteration($_POST);
}
...
function regfrom_validate()
{
	...
	if(trim(document.regform.user_pwd.value)=="")
	{ 
		alert("Please enter Password");
		document.regform.user_pwd.value='';
		document.regform.user_pwd.focus();
		return false;
	}
	if(trim(document.regform.user_cnfrmpwd.value)=="")
	{ 
		alert("Please enter Confirm Password");
		document.regform.user_cnfrmpwd.value='';
		document.regform.user_cnfrmpwd.focus();
		return false;
	}
	if(trim(document.regform.user_cnfrmpwd.value)!=trim(document.regform.user_pwd.value))
	{ 
...
function checkingUserUnique(title)
{
	jQuery.ajax({
		type: "POST",
		url: "jquery_ajax_check_controls.php",
		data: "title="+title+"&type=uname",
		success: function(msg){
		jQuery("#msgdiv_username").html(msg);		
		}
	});
}
function checkingEmailUnique(title)
{
	jQuery.ajax({
		type: "POST",
		url: "jquery_ajax_check_controls.php",
		data: "title="+title+"&type=email",
		success: function(msg){
                ...
                <td width="697" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td align="left" valign="top" style="padding-left:20px; padding-top:15px"><table width="100%" border="0" align="left">
                                  <tr>
                                    <td align="left" valign="top" class="boldtext">USER REGISTERATION</td></tr>
                                  <tr>
								 <?php if($_GET['ferr']!=""){?>
								  <tr>
								  ...
								  <?php if($_GET['err']!=""){?>
								  <tr>
                                    <td align="left" valign="top" class="red_errormessage">User registered successfully.  Please check your email for activation link. If the activation email from The Super Teens doesn't show up in your inbox, please check your junk or spam folder.</td></tr>
                                  <tr>
								  <?php }?>
									...
									<table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
                                      <tr>
                                        ...
                                        <td width="76%" height="28" align="left" valign="middle"><input type="text"  name="user_name" value="" class="text_large required" style="width:240px;" onchange="checkingUserUnique(this.value);" autocomplete="off">
										<span id="msgdiv_username" class="red_errormessage" style="width:300px;"></span>
										</td>
                                      </tr>
                                      <tr>
                                        <td height="28" align="left" valign="middle" >Password :</td>
                                        <td height="28" align="left" valign="middle"><input type="password" name="user_pwd" value="" class="text_large required" style="width:240px;"></td>
                                      </tr>
                                      <tr>
                                        <td height="28" align="left" valign="middle" >Confirm Password :</td>
                                        <td height="28" align="left" valign="middle"><input type="password" name="user_cnfrmpwd" value="" class="text_large required" style="width:240px;"></td>
                                      </tr>
                                      <tr>
                                        <td height="28" align="left" valign="middle" >Email Address :</td>
                                        <td height="28" align="left" valign="middle"><input type="text" name="user_email" value="" class="text_large required" style="width:240px;" onchange="checkingEmailUnique(this.value);"><span id="msgdiv_email" class="red_errormessage" style="width:300px;"></span></td>
                                      </tr>
									  <tr>
...
<tr><td align="left" valign="middle" height="5" ></td><td  align="left" valign="middle" height="5"></td></tr>
  ...
  <tr>
    <td width="55%" height="28" align="left" valign="middle">First Name :<br /><input type="text" name="b_firstname" id="b_firstname" value="" class="text_large required" style="width:240px;"></td>
  </tr>
  <tr>
    <td height="28" align="left" valign="middle">Last Name :<br /><input type="text" name="b_lastname" id="b_lastname" value="" class="text_large required" style="width:240px;"></td>
  </tr>
  <tr>
    <td height="28" align="left" valign="middle">Country :<br />
    <select id="b_country"  name="b_country" class="select_large required" style="width:250px;">
  ...
  <tr>
    <td height="28" align="left" valign="middle">State : <br /><input type="text" name="b_state" id="b_state" value="" class="text_large required" style="width:240px;"></td>
  </tr>
  <tr>
    <td height="28" align="left" valign="middle">Address : <br /><textarea name="b_address" id="b_address" class="text_medium required" style="width:240px; height:80px;"></textarea></td>
  </tr>
  <tr>
    <td height="28" align="left" valign="middle">City : <br /><input type="text" name="b_city" id="b_city"  value="" class="text_large required" style="width:240px;"></td>
  </tr>
  <tr>
    <td height="28" align="left" valign="middle">Zip Code : <br /><input type="text" name="b_zipcode" id="b_zipcode" value="" class="text_large required" style="width:240px;"></td>
  </tr>
  <tr>
    <td height="28" align="left" valign="middle">Fax : <br /><input type="text" name="b_fax" id="b_fax" value="" class="text_large required" style="width:240px;"></td>
  </tr>    
  <tr>
    <td height="28" align="left" valign="middle">Phone Number :<br /> <input type="text" name="b_phoneno" id="b_phoneno" value="" class="text_large required" style="width:240px;"></td>
  </tr>
  
</table></td>
    <td align="left" valign="top"><table width="95%" border="0" align="left" cellpadding="0" cellspacing="0">
  <tr>
    <td width="55%" height="28" align="left" valign="middle">First Name :<br /><input type="text" name="s_firstname" id="s_firstname" value="" class="text_large required" style="width:240px;"></td>
  </tr>
  <tr>
    <td height="28" align="left" valign="middle">Last Name :<br /><input type="text" name="s_lastname" id="s_lastname" value="" class="text_large required" style="width:240px;"></td>
  </tr>
  <tr>
    <td height="28" align="left" valign="middle">Country :<br /><?php /*?><select id="s_country"  name="s_country" class="select_large required" style="width:250px;">
                    <option value="">Select Country</option>
					<option value="Afganistan">Afghanistan</option>
                    <option value="Albania">Albania</option>
                    <option value="Algeria">Algeria</option>
...
<option  value="United States of America">United States of America</option>
  ...
  <tr>
    <td height="28" align="left" valign="middle">State : <br /><input type="text" name="s_state" id="s_state" value="" class="text_large required" style="width:240px;"></td>
  </tr>
  <tr>
    <td height="28" align="left" valign="middle">Address : <br /><textarea name="s_address" id="s_address"class="text_medium required" style="width:240px; height:80px;"></textarea></td>
  </tr>
  <tr>
    <td height="28" align="left" valign="middle">City : <br /><input type="text" name="s_city" id="s_city" value="" class="text_large required" style="width:240px;"></td>
  </tr>
  <tr>
    <td height="28" align="left" valign="middle">Zip Code : <br /><input type="text" name="s_zipcode" id="s_zipcode"value="" class="text_large required" style="width:240px;"></td>
  </tr>
  <tr>
    <td height="28" align="left" valign="middle">Fax : <br /><input type="text" name="s_fax" id="s_fax" value="" class="text_large required" style="width:240px;"></td>
  </tr>    
  <tr>
    <td height="28" align="left" valign="middle">Phone Number :<br /> <input type="text" name="s_phoneno"  id="s_phoneno"value="" class="text_large required" style="width:240px;"></td>
  </tr>
...
<td height="28" align="left" valign="middle"><input type="hidden" name="action" value="Registerhere"><input type="image" src="images/submit_51.png" value="Register"></td>
</tr>
  </table>
									</form></td>
                                  </tr>
