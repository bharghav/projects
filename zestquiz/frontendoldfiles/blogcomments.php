...
if($_POST['postcmnt']=="Submit Comment"){
	...
	if($ipcnt>0){
			$callConfig->headerRedirect("blogcomments.php?btid=".$_POST['hdn_btip']."&iperr=ipblocked");
	} else {
...
<table width="1060" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td align="left" valign="bottom" height="25"><a href="blogcomments.php?btid=<?php echo $_GET['btid'];?>#cmnt" class="morelinks"><strong>REPLY</strong></a></td>
  </tr>
</table>
						</td>
                      </tr>
					...
					<td align="center" valign="middle" height="100">No Comments..</td>
					  ...
					  ?>
						...
						$callConfig->paginavigation_FrontEnd($start, $limit, $total, 'blogcomments.php', $param);
						?>
						</ul>
						</td>
						</tr>
					   ...
					   <tr>
						...
						Please login <a href="index.php" class="morelinks">here</a> to Leave a Reply / Comment
						</td>
                      </tr>
					  <?php 
						}
						...
						<form method="post" name="cmntform" action="" onsubmit="return blogcmntvalidate();">
	 ...
	 <a href="contentpage_popup.php?pgid=17" rel="fancyvideo" class="morelinks">Click here for Terms & Conditions</a></td>
						...
						<tr>
						<td align="left" valign="middle" height="30"><input type="hidden" name="hdn_urlredirect" value="blogcomments.php" /><input type="hidden" name="hdn_btip" value="<?php echo $_GET['btid'];?>" /><input type="submit" name="postcmnt" value="Submit Comment" /></td>
						</tr>
						</table>
						</form>
						</td>
