...
if($option!="com_storeproducts_insert"){
?>
<div class="box">
<div class="heading">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
<tr>
<td align="left" valign="middle"><h1><img src="allfiles/map.jpeg" alt=""> Store &nbsp;&nbsp;>>&nbsp;&nbsp; Products</h1></td>
<td align="right" valign="bottom"><input class="button button_add" value="" type="button" onclick="window.location.href='index.php?option=com_storeproducts_insert';"></td>
</tr>
</table>
</div>
<div class="content">
          ...
          <thead>
            <tr height="25">
              ...
              <td width="808" align="left" valign="middle" class="sort">
					<div >
					<a href="index.php?option=com_storeproducts&ord=ASC&fld=prodtitle" class="up" title="up"></a>
					<a href="index.php?option=com_storeproducts&ord=DESC&fld=prodtitle" class="down" title="down"></a>
					</div>
</td>
			...
			<td align="center" valign="middle"x><a title="edit" href="index.php?option=com_storeproducts_insert&id=<?php echo $all_products->spid;?>"><img src="allfiles/icon_edit.png" alt="Edit" border="0"></a></td>
			<td align="center" valign="middle">
						<a title="delete" href="#" onClick="var q = confirm('Are you sure you want to delete selected record?'); if (q) { window.location = 'index.php?option=com_storeproducts&action=delete&id=<?php echo $all_products->spid;?>'; return false;}"><img src="allfiles/icon_delete.png"  alt="Delete" border="0"/></a>
						</td>
			</tr>
			<?php
				$ii++; } } else{
			...
			if($_GET['ord']!="")
			$param.="&fld=".$_GET['fld'];
			$callConfig->paginavigation($start, $limit, $total, 'index.php?option=com_storeproducts', $param);
			?>
			</ul>
			<?php 
			}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
<tr>
<td align="left" valign="middle"> <h1><img src="allfiles/map.jpeg" alt=""> Store &nbsp;&nbsp;>>&nbsp;&nbsp;Add Product&nbsp;&nbsp;/&nbsp;&nbsp; Edit Product</h1></td>
<td align="right" valign="bottom">&nbsp;</td>
</tr>
</table>
</div>
<div class="content">
<form action="index.php?option=com_storeproducts_insert" method="post" id="frmCreatestate" name="frmCreatestate" class="middle_form" enctype="multipart/form-data" onsubmit="return validate(this.image);">
	<table width="100%" border="0" cellspacing="0" cellpadding="0" >
			   <tr>
