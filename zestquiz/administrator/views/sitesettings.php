...
<div class="box">
  ...
  <tr>
    <td width="14%" align="left" valign="middle"><label class="title">Shipping Rate</label></td>
    <td width="86%" align="left" valign="middle"><input type="text" name="shippingamount" id="shippingamount" size="24" value="<?php echo $site_settings_disp->shippingamount; ?>" class="text_large" ></td>
  </tr>
    <tr>
    <td height="10" colspan="2" align="left" valign="middle"></td>
  </tr>
