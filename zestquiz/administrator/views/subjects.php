...
<tr>
<td align="left" valign="middle"><h1><img src="allfiles/map.jpeg" alt="">E-learning &nbsp;&nbsp;>>&nbsp;&nbsp;Subjects</h1></td>
<td align="right" valign="bottom"><input class="button button_add" value="" type="button" onclick="window.location.href='index.php?option=com_subject_insert';"></td>
</tr>
</table>
</div>
<div class="content">
...
<!--  <td width="116" align="center" valign="middle" >Image</td> -->
			...
			if($_GET['ord']!="")
			$param.="&fld=".$_GET['fld'];
			$callConfig->paginavigation($start, $limit, $total, 'index.php?option=com_subject', $param);
			?>
			</ul>
			<?php 
			}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
<tr>
<td align="left" valign="middle"> <h1><img src="allfiles/map.jpeg" alt=""> E-learning &nbsp;&nbsp;>>&nbsp;&nbsp; Add Subject &nbsp;&nbsp;/&nbsp;&nbsp; Edit Subject</h1></td>
