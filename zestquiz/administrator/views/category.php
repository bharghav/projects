...
<tr>
<td align="left" valign="middle"><h1><img src="allfiles/map.jpeg" alt="">E-learning &nbsp;&nbsp;>>&nbsp;&nbsp;Category</h1></td>
<td align="right" valign="bottom"><input class="button button_add" value="" type="button" onclick="window.location.href='index.php?option=com_cat_insert';"></td>
</tr>
</table>
</div>
<div class="content">
          ...
          <thead>
            <tr height="25">
              ...
              <td width="750" align="left" valign="middle" class="sort">
					<div >
					<a href="index.php?option=com_cat&ord=ASC&fld=catetitle" class="up" title="up"></a>
 ...
 <!-- <td width="116" align="center" valign="middle" >Image</td> -->
			...
			if($_GET['ord']!="")
			$param.="&fld=".$_GET['fld'];
			$callConfig->paginavigation($start, $limit, $total, 'index.php?option=com_cat', $param);
			?>
			</ul>
			<?php 
			}
...
<div class="content">
<form action="index.php?option=com_cat_insert" method="post" id="frmCreatestate" name="frmCreatestate" class="middle_form" enctype="multipart/form-data" onsubmit="return validate(this.image);">
	<table width="100%" border="0" cellspacing="0" cellpadding="0" >
	<tr>
