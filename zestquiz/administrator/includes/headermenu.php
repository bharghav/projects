  ...
  <div class="div1">
    ...
    <ul class="left sf-js-enabled" style="display: block; ">
	 ...
	 <?php /*?> <li  <?php echo $left_sitesettings_focus;?>><a href="index.php?option=com_sitesettings" class="top">Site Settings</a></li><?php */?>
	  ...
	  <li id="catalog" <?php echo $left_sitesettings_focus;?>><a class="top"  href="index.php?option=com_sitesettings">Site Settings</a>
        <ul style="display: none; visibility: hidden; ">
         ...
         <!--li><a href="index.php?option=com_iptrace">IP Address</a></li-->
        </ul>
      </li>
	 ...
	 <li id="catalog" <?php echo $left_adminlist_focus;?>><a class="top"  href="#">Users</a>
        <ul style="display: none; visibility: hidden; ">
		 <li><a href="index.php?option=com_adminlist">Admin Users</a></li>
		  <li><a href="index.php?option=com_adminlist_insert">&nbsp;&nbsp;&nbsp;&nbsp;&raquo;&raquo; Add AdminUser</a></li>
	  ...
	  <li id="catalog" <?php echo $left_homebanners_focus;?>><a class="top"  href="index.php?option=com_bannerslist">Banners</a>
        <ul style="display: none; visibility: hidden; ">
     ...
     <?php /* ?><li id="catalog" <?php echo $left_artcles_focus;?>><a class="top"  href="#">Home Articles</a>
	  ...
	  <?php /*?><li id="catalog" <?php echo $left_forumcat_focus;?>><a class="top"  href="#">Forum</a>
        <ul style="display: none; visibility: hidden; ">
      ...
      <li id="catalog" <?php echo $left_learning_focus;?>><a class="top"  href="#">E-learning</a>
        <ul style="display: none; visibility: hidden; ">
      ...
      <li id="catalog" <?php echo $left_exams_focus;?>><a class="top"  href="#">Exams</a>
		<ul style="display: none; visibility: hidden; ">
		<li><a href="index.php?option=com_exam">Exams</a></li>
		<li><a href="index.php?option=com_exam_insert">&nbsp;&nbsp;&nbsp;&nbsp;&raquo;&raquo;&nbsp;&nbsp;Add Exam</a></li>
		</ul>
      </li>
      <li id="catalog" <?php echo $left_question_focus;?>><a class="top"  href="#">Questions</a>
		<ul style="display: none; visibility: hidden; ">
		<li><a href="index.php?option=com_question">Questions</a></li>
	...
	<ul class="left sf-js-enabled" style="display: block; ">
      <li  <?php echo $left_dashboard_focus;?>><a href="index.php" class="top">Dashboard</a></li>
	  <li id="catalog" <?php echo $left_artcles_focus;?>><a class="top"  href="#">Home Articles</a>
        <ul style="display: none; visibility: hidden; ">
		  <li><a href="index.php?option=com_articlepost">Articles</a></li>
		  <li><a href="index.php?option=com_articlepost_insert">&nbsp;&nbsp;&nbsp;&nbsp;&raquo;&raquo;&nbsp;&nbsp;Add Article</a></li>
		  <li><a href="index.php?option=com_articlecommnets">Article Comments</a></li>
