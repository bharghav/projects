 ...
 function get_userfirst_datails($tablename,$where)
 {
  ...
  function userRegistration($post)
	...
	if($res!="")
	{
		...
		<tr>
		<td  colspan='2' align='left' valign='top'><strong>Your registeration is completed successfully</strong></td>
		</tr>
		<tr>
		<td valign='top' colspan='2' align='left'>Username :: ".$post['user_name']."</td>
		</tr>
		<tr>
		<td valign='top' colspan='2' align='left'>Password :: ".$post['user_pwd']."</td>
		</tr>
		<tr>
		<td valign='top' colspan='2' align='left'><strong>Please click  the below link to activate your account</strong></td>
		</tr>
		<tr>
		<td valign='top' colspan='2' align='left'><a href='".SITEURL."/useractivation.php?activationid=".$urllink."'>Click Here<a/></td>
		</tr>
		<tr>
		...
		$to=$post['user_email'];
		$subject="The Super Teens User Registeration";
		...
		if(mail($to,$subject,$message,$headers))
		{
			...
			$callConfig->headerRedirect("login.php?err=User registered successfull!!!");
			exit;
		}
		else
		{
			$callConfig->headerRedirect("login.php?err=User registered successfully, but mail sending failed");
			exit;
		}
	}
	else
	...
	{
		$message='<table width="800" border="0" cellspacing="3" cellpadding="3" style="border:1px solid #eeeeee">
		<tr>
